...
window.addEventListener('load', function () {
  var button = document.getElementById('btn_dropdown');
  var exListbox = new aria.Listbox(document.getElementById('ul_dropdown'));
